        ...
        {!isSubmitted ? (
          <form onSubmit={handleSubmit}>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 px-4 bg-gray-600 border border-white text-white font-bold rounded-lg shadow-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 transition duration-200"
              type="submit"
            >
              {isLoading ? (
